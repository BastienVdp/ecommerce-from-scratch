<div class="flex gap-4 w-full flex">
		<div class="w-3/4 flex flex-col">
			...
			<div class="w-full">
				<img src="<?= $product['image'] ?>" alt="Two each of gray, white, and black shirts laying flat." class="w-full object-cover object-center rounded-lg">
			</div>
		</div>
		<div class="w-2/4">
			...
			<div class="mt-4 lg:mt-0">
				...
				<form class="mt-10" action="/cart/store" method="post">          
